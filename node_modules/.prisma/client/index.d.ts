...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__ProductClient<T, Null = never> implements PrismaPromise<T> {
    ...
    updates<T extends Product$updatesArgs= {}>(args?: Subset<T, Product$updatesArgs>): PrismaPromise<Array<UpdateGetPayload<T>>| Null>;
  ...
  export type UpdateSelect = {
    ...
    UpdatePoint?: boolean | Update$UpdatePointArgs
  ...
  export type UpdateGetPayload<S extends boolean | null | undefined | UpdateArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'UpdatePoint' ? Array < UpdatePointGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'UpdatePoint' ? Array < UpdatePointGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UpdateClient<T, Null = never> implements PrismaPromise<T> {
    ...
    UpdatePoint<T extends Update$UpdatePointArgs= {}>(args?: Subset<T, Update$UpdatePointArgs>): PrismaPromise<Array<UpdatePointGetPayload<T>>| Null>;
   ...
   * Update.UpdatePoint
   */
  export type Update$UpdatePointArgs = {
    /**
